	...
	public String  carouselfeature(Utilities utility){
		...
		for(String user: prodRecmMap.keySet())
		{
			if(user.equals(utility.username()))
			{
				...
				sb.append("<a style='font-size: 25px;'>"+""+" Recommended Products</a>");
				...
				*/
				...
				for(String prod : productsList){
					...
					if (k==0 )
					{
						...
						sb.append("<div class='item active'><div style = 'background-color: #58acfa;border :5px solid #cfd1d3;position:relative;min-height:1px;padding-right:15px;padding-left:15px;float:left;width:40%;'>");
					}
					else
					{
						sb.append("<div class='item'><div style = 'background-color: #58acfa ;border :5px solid #cfd1d3;position:relative;min-height:1px;padding-right:15px;padding-left:15px;float:left;width:40%;' >");
					}
