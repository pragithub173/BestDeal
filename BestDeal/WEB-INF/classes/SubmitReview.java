...
public class SubmitReview extends HttpServlet {
	...
	protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String message=utility.storeReview(productname,producttype,productmaker,reviewrating,reviewdate,reviewtext,retailerpin,productprice,retailercity,retailername,retailerstate,productsale,manufacturerebate,userid,userage,usergender,useroccupation);				     
