		...
		pw.print("<input type='hidden' name='productmaker' value='"+productmaker+"'>");
                pw.print("</td></tr><table>");
  				...
  				pw.print("<table><tr></tr><tr></tr><tr><td> Review Rating: </td>");
					...
					pw.print("<td> <input type='text' name='retailername'> </td>");
					pw.print("</tr>");
					...
					pw.print("<tr>");
					pw.print("<td> Manufacture Rebate: </td>");
					pw.print("<td> <input type='text' name='manufacturerebate'> </td>");
					pw.print("</tr>");
					
					pw.print("<tr>");
					pw.print("<td> Productson Sale: </td>");
					pw.print("<td> <input type='text' name='productsale'> </td>");
					pw.print("</tr>");
