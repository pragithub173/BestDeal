...
public class Game extends HttpServlet{
	...
	public Game(/*String id,*/String name, double price, String image, String retailer,String condition,double discount,int inventory){
		//this.id=id;
		this.name=name;
		this.price=price;
		this.image=image;
	...
	public Game(String name, double price, int inventory) {
        this.name = name;
        this.price = price;
        this.inventory = inventory;
    }
