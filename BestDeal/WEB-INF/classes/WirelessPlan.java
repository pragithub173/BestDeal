...
public class WirelessPlan extends HttpServlet{
	...
	public WirelessPlan(String name, double price, String image, String retailer, String condition,double discount,int inventory){
		this.name=name;
		this.price=price;
		this.image=image;
	...
	public WirelessPlan(String name, double price, int inventory) {
        this.name = name;
        this.price = price;
        this.inventory = inventory;
    }
