	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='consoles' selected>Sound System</option><option value='games'>Phones</option><option value='tablets'>Television</option><option value='laptops'>Laptops</option><option value='voices'>Voice Assistant</option><option value='fitnesswatches'>Fitness Watches</option><option value='smartwatches'>Smart Watches</option><option value='headphones'>Headphones</option><option value='wirelessplans'>Wireless Plans</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
