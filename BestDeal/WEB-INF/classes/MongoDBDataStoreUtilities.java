	...
	try
		{		
			...
			BasicDBObject doc = new BasicDBObject("title", "myReviews").
				...
				append("productsale",productsale).
...
{	
	...
	while (cursor.hasNext())
	{
		   ...
		   if(!reviews.containsKey(obj.getString("productName")))
			...
			//String productname,String producttype,String productprice,String productmaker,String retailerpin,String retailercity,
			//String retailerstate,String productonsale,String manufacturerrebate,String userid,String userage,String usergender,
			...
			Review review =new Review(obj.getString("productName"),obj.getString("userName"),obj.getString("productType"),obj.getString("productMaker"),
				obj.getString("reviewRating"),obj.getString("reviewDate"),obj.getString("reviewText"),obj.getString("retailerpin"),obj.getString("price"),obj.getString("retailercity"),obj.getString("retailername"),obj.getString("retailerstate"),obj.getString("productsale"),obj.getString("manufacturerebate"),obj.getString("userid"),obj.getString("userage"),obj.getString("usergender"),obj.getString("useroccupation"));
